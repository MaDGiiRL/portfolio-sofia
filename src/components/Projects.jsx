...
export default function Projects() {
    ...
    return (
        <section className="flex-col-wise">
            <div className="container flex-col-wise mb-5">
                <div className="projectContainer row g-3">
                    <div className="header">
                        ...
                        <p className="subtitle">{t('projects1')}</p>
                    </div>
