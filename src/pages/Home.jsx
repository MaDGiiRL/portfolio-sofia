...
export default function Home() {
    ...
    useEffect(() => {
        ...
        const config = {
            div: { radius: 5, maxRadius: 29, speed: 0.3, opacity: 0, maxOpacity: 0.2, opacityStep: 0.05 },
            text: { radius: isMobile ? 180 : 29, maxRadius: 49, speed: 0.2, opacity: isMobile ? 0.8 : 0.2, maxOpacity: 1, opacityStep: 0.1 },
        };
        ...
        function animateParticles() {
            ...
            for (let i = activeParticles - 1; i >= 0; i--) {
                ...
                if (particle.life <= 0) {
                    activeParticles--;
                    if (i < activeParticles) particlePool[i] = particlePool[activeParticles];
                }
            }
            createParticle();
            ...
            <section className="heroSection d-flex flex-column min-vh-50">
                ...
                <div className="container-fluid d-flex flex-column">
                    <div className="row">
                        ...
                        <motion.p
                            className="text-center p-2 lead text-white fs-1 pt-5"
                            initial="hidden"
                            whileInView="visible"
                            viewport={{ once: true, amount: 0.2 }}
                            variants={fadeInUp}
